        ...
        switch (tier.name) {
            case 'Member':
                return selected
                    ...
                    : 'opacity-80 cursor-pointer p-2 font-semibold text-green-600 hover:text-green-700 bg-green-400/10 hover:bg-green-400/30 border-green-600/20 hover:border-green-600/50 dark:text-green-300 dark:hover:text-green-100 dark:bg-green-400/5 dark:hover:bg-green-400/30 dark:border-green-300/20 dark:hover:border-green-300/50';

            case 'Silver':
                return selected
                    ? 'cursor-pointer p-2 font-semibold text-blue-700 hover:text-blue-700 bg-blue-400/30 hover:bg-blue-400/30 border-blue-600/50 hover:border-blue-600/50 dark:text-blue-100 dark:hover:text-blue-100 dark:bg-blue-400/30 dark:hover:bg-blue-400/30 dark:border-blue-300/50 dark:hover:border-blue-300/50'
                    : 'opacity-80 cursor-pointer p-2 font-semibold text-blue-600 hover:text-blue-700 bg-blue-400/10 hover:bg-blue-400/30 border-blue-600/20 hover:border-blue-600/50 dark:text-blue-300 dark:hover:text-blue-100 dark:bg-blue-400/5 dark:hover:bg-blue-400/30 dark:border-blue-300/20 dark:hover:border-blue-300/50';
            ...
            case 'Platinum':
                return selected
                    ? 'cursor-pointer p-2 font-semibold text-sky-700 hover:text-sky-700 bg-sky-400/30 hover:bg-sky-400/30 border-sky-600/50 hover:border-sky-600/50 dark:text-sky-100 dark:hover:text-sky-100 dark:bg-sky-400/30 dark:hover:bg-sky-400/30 dark:border-sky-300/50 dark:hover:border-sky-300/50'
                    : 'opacity-80 cursor-pointer p-2 font-semibold text-sky-600 hover:text-sky-700 bg-sky-400/10 hover:bg-sky-400/30 border-sky-600/20 hover:border-sky-600/50 dark:text-sky-300 dark:hover:text-sky-100 dark:bg-sky-400/5 dark:hover:bg-sky-400/30 dark:border-sky-300/20 dark:hover:border-sky-300/50';
