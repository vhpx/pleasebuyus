                    ...
                    {user || (
                        <div className="w-full text-center">
                            ...
                            <div className="mt-4 grid gap-2">
                                ...
                                <BetterLink
                                    href="/signup"
                                    className="col-span-2 rounded-lg bg-red-300/20 dark:bg-red-300/20 dark:hover:bg-red-400/40 hover:bg-red-300/30 text-red-600 dark:text-red-300 dark:hover:text-red-200 px-2 py-1 font-semibold transition duration-300"
                                >
                                    Sign up
                                </BetterLink>
                            </div>
