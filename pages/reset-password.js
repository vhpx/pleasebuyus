...
export default function ResetPasswordPage() {
    ...
    return (
        <div className="relative text-black dark:text-white flex h-screen flex-col items-center justify-center bg-gradient-to-br from-green-300 via-blue-500 to-purple-600 dark:from-[#0d324d] dark:to-[#7f5a83] md:bg-gradient-to-r">
            <BetterLink
                href="/settings"
